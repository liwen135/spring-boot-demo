...
public class JacksonSampleController {
    ...
    public @ResponseBody
    String readtree() throws JsonProcessingException, IOException {
    ...
    public @ResponseBody
    String databind() throws JsonProcessingException, IOException {
        String json = "{\"name\":\"lijz\",\"id\":10}";
    ...
    public @ResponseBody
    String custom() throws JsonProcessingException {
